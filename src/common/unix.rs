...
use crate::models::interface::Netmask;

pub fn ipv4_from_in_addr(internet_address: &in_addr) -> Result<Ipv4Addr, Error> {
...
pub fn ipv6_from_in6_addr(internet_address: &in6_addr) -> Result<Ipv6Addr, Error> {
